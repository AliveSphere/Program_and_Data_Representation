// Charles Buyas, cjb8qf, 4-24-17, middleearth.cpp
...
/** @brief This creates the list of all the
 * city names that will be in middleearth.cpp.
 */
...
/** @brief This is the constructor for Middle Earth.
 *
 * This function will create an instance of a MiddleEarth object.
 * This basically makes a graph of randomly placed city connections.
 * @param xsize Gives the x distance of the 2-D distance array.
 * @param ysize Gives the y distance of the 2-D distance array.
 * @param num_cities Holds the number of cities being used.
 * @param seed Influences the random number generator.
 * @todo Create a middle earth object.
 */
...
/** @brief This is the deconstructor for Middle Earth.
 *
 * This function will destroy Middle Earth if left alone.
 */
...
/** @brief This is Middle Earth's printer.
 *
 * This is the Mouth of Sauron and will print out info on
 * the world that has been created by the constructor.
 * @return This is a void function with no return value.
 * @todo Use the mouth of Sauron to communicate.
 */
...
/** @brief This is a table of war data.
 *
 * This function will create a table with the data 
...
/** @brief This returns the distance between the two passed cities.
 *
 * This function will compare the indices of two cities
 * in order to calculate the difference in their x and y.
 * @param city1 Has the information for city1.
 * @param city2 Has the information for city2.
 * @return Returns the distance.
 * @todo Check for the traveling sales war monger.
 */
...
/** @brief This is the annoying mom on the journey. (planner)
 *
 * This function will create an 'itinerary' for the journey.
 * @param length Will let us know how f***ing far we need to walk.
 * @return Returns the itinerary.
 * @todo Make a plan for travel.
 */
